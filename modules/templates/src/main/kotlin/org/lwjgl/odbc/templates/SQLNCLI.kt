...
import org.lwjgl.generator.LongConstant
...
val sqlncli = "SQLNCLI".nativeClass(ODBC_PACKAGE, prefix = "SQL", prefixMethod = "SQL", binding = ODBC_BINDING_DELEGATE) {
	...
	documentation =
		"""
		Native bindings to the <a href="https://msdn.microsoft.com/en-us/data/ff658532.aspx">SQL Server Native Client</a>.
	...
	IntConstant(
		"SQL#ColAttribute() & SQL#SetDescField()/SQL#GetDescField() driver specific defines.",
	...
	IntConstant(
		"Defines returned by SQL#ATTR_CURSOR_TYPE.",
	...
	IntConstant(
		"SQL#TXN_ISOLATION_OPTION bitmasks.",
	...
	IntConstant(
		"User Data Type definitions. Returned by SQL#ColAttribute()/#CA_SS_COLUMN_UTYPE.",
	...
	IntConstant(
		"Aggregate operator types. Returned by SQL#ColAttribute()/#CA_SS_COLUMN_OP.",
	...
	IntConstant(
		"SQL#GetInfo() driver specific define.",
	...
	IntConstant(
		"SQL#GetDiagField() driver specific defines.",
	...
	IntConstant(
		"SQL#GetDiagField()/#DIAG_DYNAMIC_FUNCTION_CODE driver specific defines.",
