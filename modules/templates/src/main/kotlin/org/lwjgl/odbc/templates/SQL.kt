...
val sql = "SQL".nativeClass(ODBC_PACKAGE, prefix = "SQL", prefixMethod = "SQL", binding = ODBC_BINDING) {
	documentation =
		"""
		Native bindings to <a href="https://msdn.microsoft.com/en-us/library/ms710252.aspx">ODBC</a>.
	...
	IntConstant(
		...
		"DRIVER_SQL_TYPE_BASE"..0x4000,
		"DRIVER_DESC_FIELD_BASE"..0x4000,
		"DRIVER_DIAG_FIELD_BASE"..0x4000,
		"DRIVER_INFO_TYPE_BASE"..0x4000
	)
	...
	NativeName("SQLGetDescRecW")..SQLRETURN(
		...
		Check(1)..SQLSMALLINT_p.OUT("TypePtr", ""),
		Check(1)..SQLSMALLINT_p.OUT("SubTypePtr", ""),
		Check(1)..SQLLEN_p.OUT("LengthPtr", ""),
		Check(1)..SQLSMALLINT_p.OUT("PrecisionPtr", ""),
		Check(1)..SQLSMALLINT_p.OUT("ScalePtr", ""),
	...
	SQLRETURN(
		...
		SQLPOINTER.IN("ParameterValuePtr", ""),
		AutoSize("ParameterValuePtr")..SQLLEN.IN("BufferLength", ""),
		Check(1)..SQLLEN_p.IN("StrLen_or_IndPtr", "")
	)
